...
public function actionCreate(){
  ...
  if(isset($_POST['Collections'])){
    ...
    if($model->save()){
      Yii::app()->user->setFlash('success', 'Collection has been added!');
      $this->redirect(array('reports/advanceTicketSales'));
    }
  }
...
public function actionUpdate($id){
  ...
  if(isset($_POST['Collections'])){
    $model->attributes=$_POST['Collections'];
    if($model->save()){
       Yii::app()->user->setFlash('success', 'Collection has been updated!');
      $this->redirect(array('reports/advanceTicketSales'));
    }
  }
